                      ...
                      <div class="card-inner-group">
                          ...
                          <div class="card-inner p-0">
                              <div class="nk-tb-list nk-tb-ulist">
                                  ...
                                  @foreach($restaurants as $dat)
                                    <div class="nk-tb-item">
                                      <div class="nk-tb-col tb-col-md">
                                          <span><img src="{{URL::asset('uploads')}}/{{$dat->image}}" class="img-fluid" width="150px" /></span>
                                      </div>
                                      <div class="nk-tb-col tb-col-md">
                                          <span>{{ $dat->title }}</span>
                                      </div>
                                                  ...
                                                  <div class="drodown">
                                                      ...
                                                      <div class="dropdown-menu dropdown-menu-right">
                                                          <ul class="link-list-opt no-bdr">
                                                              <li><a href="{{route('Restaurant.edit', $dat->id)}}"><em class="icon ni ni-eye"></em><span>Edit Details</span></a></li>
                                                          </ul>
                                                      </div>
                                                  </div>
                                              </li>
