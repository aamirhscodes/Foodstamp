                          ...
                          <div class="components-preview wide-md mx-auto">
                              <div class="nk-block-head nk-block-head-lg wide-sm">
                                  <div class="nk-block-head-content">
                                      ...
                                      <h2 class="nk-block-title fw-normal">Add Stamp</h2>
                                  </div>
                              </div><!-- .nk-block-head -->
                              <div class="nk-block nk-block-lg">
                                  <div class="card card-preview">
                                      <div class="card-inner">
                                        <form name="addForm" method="POST" action="{{ route('Stamp.store') }}" enctype="multipart/form-data">
                                          @csrf
                                              ...
                                              <div class="row gy-4">
                                                  ...
                                                  <div class="col-sm-12">
                                                      <div class="form-group">
                                                          ...
                                                          <div class="form-control-wrap">
                                                              <input type="number" name="price" class="form-control" id="inputLastName" placeholder="Price"  required>
                                                          </div>
                                                      </div>
                                                  </div>
                                                  <div class="col-sm-12">
                                                      <div class="form-group">
                                                          ...
                                                          <div class="form-control-wrap">
                                                              <input type="text" name="description" class="form-control" id="inputLastName" placeholder="Description"  required>
                                                          </div>
                                                      </div>
                                                  </div>
                                                  <div class="col-sm-12">
