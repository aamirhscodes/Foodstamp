...
<div class="page-wrapper">
	...
	<!-- Container fluid  -->
	<!-- ============================================================== -->
	<form method="post" action="{{url('addinvoicePost')}}" enctype="multipart/form-data">
		@csrf
		<div class="container-fluid">
			<div class="row page-titles">
				<div class="col-md-5 align-self-center">
					<h3 class="text-themecolor">Add Invoice</h3>
					<ol class="breadcrumb">
			...
			<div class="row">
				<div class="col-sm-12 col-xs-12">
					<div class="form-group">
						...
						<div>
							<input type="text" class="form-control font-14" placeholder="Title" id="title" name="title"> </div>
					</div>
				</div>
				<div class="col-sm-12 col-xs-12">
					<div class="form-group">
			...
			<div class="row">
				<div class="col-sm-12 col-xs-12">
					<div class="form-group">
						...
						<div>
							<input type="number" class="form-control font-14" placeholder="Fixed Amount" id="fixed_amount" name="fixed_price" required> </div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-12 col-xs-12">
					<div class="form-group">
						...
						<div>
							<input type="number" class="form-control font-14" placeholder="Monthly Amount" id="monthly_amount" name="monthly_price" required> </div>
					</div>
				</div>
			</div>
			<
