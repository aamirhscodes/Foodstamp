...
<div class="page-wrapper">
	...
	<!-- Container fluid  -->
	<!-- ============================================================== -->
	<form method="post" action="{{url('addCustomerPost')}}" enctype="multipart/form-data">
		@csrf
			...
			<div class="row">
				<div class="col-sm-6 col-xs-6">
					<div class="form-group">
						...
						<div>
							<input type="text" class="form-control font-14" placeholder="name" id="name" name="name"> </div>
					</div>
				</div>
				<div class="col-sm-6 col-xs-6">
					<div class="form-group">
						...
						<div>
							<input type="text" class="form-control font-14" placeholder="business" id="business" name="business"> </div>
					</div>
				</div>
				<div class="col-sm-6 col-xs-6">
					<div class="form-group">
						...
						<div>
							<input type="email" class="form-control font-14" placeholder="email" name="email" id="email"> </div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-12 col-xs-12">
					<div class="form-group">
						...
						<div>
							<input type="tel" class="form-control font-14" placeholder="phone" id="phone" name="phone"> </div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-12 col-xs-12">
					<div class="form-group">
						...
						<div>
							<input type="text" class="form-control font-14" placeholder="Address" id="address" name="address"> </div>
					</div>
				</div>
			</div>
