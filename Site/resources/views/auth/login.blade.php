...
<div id="c">
  ...
  <div class="col-lg-10 offset-lg-1 text-center">
    <h3 class="nw mt-0 mb-">Please enter your credentials below to login to your account in Sign HQ
      <hr>
    </h3>
  </div>
  <div class="d-flex flex-wrap col-lg-10 offset-lg-1" id="contact-details">
    <div class="col-12 col-lg-6 p-0">
      <form name="contact" method="post" novalidate="novalidate" id="contact-form" action="{{route('login')}}">
        @csrf
        ...
        <div class="cfe-c">
          <label for="cf-email">
            <label for="contact_email" class="required">Password</label>
          </label>
          <input type="password" id="contact_email" name="password" required="required" style="width:100%">
        </div>
        <button type="submit" id="contact-submit-enquiry">Login</button>
      </form>
    </div>
