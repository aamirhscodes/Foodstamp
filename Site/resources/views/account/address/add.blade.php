...
<div id="c" style="padding:20px;overflow:hidden;">
    ...
    <div class="col-8 px-3">
       <div class="ui segment">
          ...
          <hr>
          <form name="sylius_address" method="post" action="{{route('addressAddPost')}}" class="ui loadable form" novalidate="novalidate">
            @csrf
            <div class="form-group">
              <label for="address_label" class="required">Address Label</label>
              <input type="text" id="address_label" name="address_label" required="required" class="form-control">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" id="county" name="county" required="required" class="form-control">
            </div>
            <div class="form-group">
              <label for="postcode" class="required">Post Code</label>
              <input type="text" id="postcode" name="postcode" required="required" class="form-control">
            </div>
             <div class="d-flex justify-content-between">
                <div class="right aligned column">
                   <button type="submit" class="btn btn-primary">Add new address
                   </button>
                </div>
             </div>
          </form>
